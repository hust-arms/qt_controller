...
namespace qt_controller{
    /**
     * @brief Kinetic parameters of qt
     */ 
    struct QTKinetic{
         ...
         */ 
        /*
        QTKinetic(double x, double y, double z, double phi, double theta, double psi,
    ...
    struct QTBodyParams{
         ...
         */ 
        /*
        QTBodyParams(double m, double l, double w, double b,
